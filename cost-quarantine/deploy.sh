...
MANAGEMENT_STACK_NAME="${STACK_NAME:-paws-cost-quarantine}"
TEST_ROLE_STACKSET_NAME="${TEST_ROLE_STACKSET_NAME:-paws-cost-quarantine-test-role}"
REGIONAL_STACKSET_NAME="${REGIONAL_STACKSET_NAME:-paws-cost-quarantine-regional}"
IDENTITY_STACK_NAME="${IDENTITY_STACK_NAME:-paws-idc-permission-sets}"
...
TEST_REMEDIATION_ROLE_NAME="${TEST_REMEDIATION_ROLE_NAME:-paws-cost-quarantine-remediation}"
...
if [[ "$ENABLE_REMEDIATION" == "true" ]]; then
  ...
  regional_role_arn="arn:aws:iam::${management_account_id}:role/paws-cost-quarantine-regional-states"
  regional_trigger_role_arn="arn:aws:iam::${management_account_id}:role/paws-cost-quarantine-regional-trigger"
